...
hs <- makeParamSet( 
         makeNumericParam("eta",              lower=  0.001 , upper=    0.02),   #equivalente a learning rate
         makeNumericParam("colsample_bytree", lower=  0.2  , upper=    0.5),   #equivalente a feature_fraction
         makeIntegerParam("min_child_weight", lower=  0L   , upper=   10L),    #groseramente equivalente a  min_data_in_leaf
         makeIntegerParam("max_depth",        lower=  2L   , upper=   5L),    #profundidad del arbol, NO es equivalente a num_leaves
