...
hs <- makeParamSet( 
         makeNumericParam("learning_rate",    lower=  0.001 , upper=    0.06),
         makeNumericParam("feature_fraction", lower=  0.15  , upper=    0.4),
         makeIntegerParam("min_data_in_leaf", lower=  1000    , upper= 4000),
