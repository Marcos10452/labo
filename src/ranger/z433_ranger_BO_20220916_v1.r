...
hs  <- makeParamSet(
  makeIntegerParam("num.trees" ,        lower=  200L, upper= 1200L),  #la letra L al final significa ENTERO
  makeIntegerParam("max.depth",         lower=    10L, upper=   35L),  # 0 significa profundidad infinita
  makeIntegerParam("min.node.size" ,    lower=    30L, upper=  600L),
