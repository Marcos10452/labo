...
ArbolesMontecarlo  <- function( semillas, param_basicos )
{
    ...
    ganacias_finales<-c(ganancia_promedio,ganancias)
    
    return( ganacias_finales )
}
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
...
archivo_salida  <- "./exp/HT2020/gridsearch_20220910_20.txt"
...
maxdepth<-c(20)
#maxdepth<-c( 50) 
minsplit<-c(800,750,700,650,600,500)
#minsplit<-c( 50 )
minbucket<-c(200)
cp<-c(-1)
#cp<-c(0.01)
for( vmax_depth  in  maxdepth)
{
        ...
        {
          for( vmin_minbucket  in  minbucket)
          {
                  ...
                  for( vmin_cp  in  cp)
                  {
                      ...
                      print(vmin_cp)
                      vmin_minbucket=round(vmin_split/3.2)
                      ...
                      ganancia_pro<-unlist(ganancia_promedio[1])
                      semilla1<-round(unlist(ganancia_promedio[2])/ganancia_pro,2)
                      semilla2<-round(unlist(ganancia_promedio[3])/ganancia_pro,2)
                      semilla3<-round(unlist(ganancia_promedio[4])/ganancia_pro,2)
                      semilla4<-round(unlist(ganancia_promedio[5])/ganancia_pro,2)
                      semilla5<-round(unlist(ganancia_promedio[6])/ganancia_pro,2)
