...
kexperimento   <- "K200_M1_seed1_30%"                       #Nombre del experimiento
...
# Script setting: K200, training month=1, undersampleing=30%, repeat= 1 seed.
...
setwd( paste0( kdirectortioexp) )   #Establezco el Working Directory DEL EXPERIMENTO
